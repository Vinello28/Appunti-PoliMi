...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btn_elenco_Click(object sender, EventArgs e)
    {
        Session.Add("Città", dati.Tables["Città"]);
        Response.Redirect("Elenco_citta.aspx");
    }

    protected void btn_hobby_Click(object sender, EventArgs e)
    {
        Session.Add("Hobby", dati.Tables["Hobby"]);
        Response.Redirect("Elenco_Hobby.aspx");
    }
}